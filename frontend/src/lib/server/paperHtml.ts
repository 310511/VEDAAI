...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: Helvetica, Arial, sans-serif; color: #111; padding: 40px; font-size: 12px; line-height: 1.6; }
    ...
    .meta-row { display: flex; justify-content: space-between; margin: 16px 0; font-size: 11px; }
    .student-info { border: 1px solid #ddd; padding: 12px; margin: 16px 0; font-size: 11px; }
    .student-info span { margin-right: 40px; }
    .note { font-style: italic; text-align: center; margin: 12px 0; font-size: 11px; color: #555; }
    .section { margin-top: 24px; page-break-inside: avoid; }
    .section h2 { font-size: 14px; font-weight: 700; margin-bottom: 4px; }
    .instruction { color: #555; margin-bottom: 12px; font-size: 11px; }
    .question { margin-bottom: 16px; }
    .q-header { margin-bottom: 4px; }
    .q-num { font-weight: 600; }
    .badge { font-size: 10px; font-weight: 600; margin-left: 8px; }
    .marks { font-size: 10px; color: #666; margin-left: 8px; }
    .q-text { padding-left: 20px; margin-top: 4px; }
    .answer-key { margin-top: 32px; page-break-before: always; }
    .answer-key h2 { margin-bottom: 12px; font-size: 14px; }
